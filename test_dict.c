...
void test_struct_convertor(void)
{
    ...
    ugeneric_convertor_data_descriptor_t gcdd1[] = {
    ...
    ugeneric_convertor_data_descriptor_t gcdd2[] = {
        {"i",        G_INT_T, offsetof(s2_t, i),       G_INT(-1)},
        {"j",        G_INT_T, offsetof(s2_t, j),       G_INT(-11)},
        {"k",        G_INT_T, offsetof(s2_t, k),       G_INT(-111)},
        {0},
    };
    ugeneric_convertor_data_descriptor_t gcdd3[] = {
        {"str",      G_STR_T,  offsetof(s3_t, str),     G_STR("str")},
        {"ref",      G_DICT_T, offsetof(s3_t, ref),     G_PTR(0), false, gcdd1, sizeof(s1_t)},
        {"refs",     G_DICT_T, offsetof(s3_t, refs),    G_PTR(0), true,  gcdd2, sizeof(s2_t)},
        {0},
    };

    // custom_struct_t
    ugeneric_t gptr = udict_convert_to_struct(G_AS_PTR(g), sizeof(s1_t), gcdd1);
    ...
    // custom_struct1_t
    gptr = udict_convert_to_struct(G_AS_PTR(g1), sizeof(s3_t), gcdd3);
    UASSERT_NO_ERROR(gptr);
